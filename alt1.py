...
📙<b> О скрипте: </b> \n<b> Скрипт был разработан только для развлечения, а не каких либо других целей. </b> \n<b>  Команды и функции скрипта будут пополняться.</b> \n<b> Если появились какие-то вопросы то вы можете обратиться к разарботчику @ToXicUse</b>
